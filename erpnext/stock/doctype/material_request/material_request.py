...
def get_permission_query_conditions(user):
    #restricting the users from having access to the MR if not the owner or approver or from procurement division
    ...
    if  "Approver" in user_roles:
        return """(
        `tabMaterial Request`.workflow_state = 'Waiting Approval'
		or
